...
<section class="py-12">
    <div class="container mx-auto px-4 md:px-8" data-aos="zoom-in">        
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-0 shadow-xl rounded-xl overflow-hidden border border-gray-100" >
                    ...
                    <?php else: ?>
                        <div class="space-y-5">
                            ...
                            <a href="detail_event?id=<?= $item['id'] ?>" class="block group">
                                <div class="flex gap-4 items-start p-3 -mx-2 rounded-lg hover:bg-red-50 transition-all border-b border-gray-50 last:border-0">
                                    <div class="shrink-0 w-16 h-16 rounded-xl bg-gray-50 text-gray-600 flex flex-col items-center justify-center border border-gray-200 group-hover:bg-red-950 group-hover:text-white group-hover:border-red-950 transition-colors shadow-sm">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-gray-800 text-base leading-snug group-hover:text-red-950 transition-colors mb-1.5">
            ...
            <div class="bg-red-950 p-8 text-white relative overflow-hidden flex flex-col justify-between" 
                ...
                <div class="absolute bottom-0 left-0 -mb-4 -ml-4 w-24 h-24 bg-red-400 rounded-full opacity-10 blur-xl"></div>
                ...
                <div data-aos="zoom-in">
                    ...
                    <?php if(empty($agendas)): ?>
                        <p class="text-red-200 italic text-base">Tidak ada agenda mendatang.</p>
                    <?php else: ?>
                            ...
                            <a href="detail_agenda?id=<?= $agenda['id'] ?>" class="flex items-center gap-5 group cursor-pointer p-2 -mx-2 rounded-xl hover:bg-white/5 transition-all duration-300">
                                ...
                                <div class="grow flex items-center justify-between">
                                    <div class="pr-2">
                                        ...
                                        <span class="text-sm text-red-200 mt-1 block group-hover:text-white font-medium"><?= date('l, Y', $time) ?></span>
                                    </div>
                ...
                <div data-aos="zoom-in">
                    ...
                    <?php else: ?>
                        <div class="space-y-8">
                            ...
                            ?>
                            <div class="group relative pl-5 border-l-4 border-gray-100 hover:border-red-950 transition-colors duration-300">
                                ...
                                <h4 class="font-bold text-gray-800 text-xl leading-tight group-hover:text-red-900 transition-colors mb-3">
                                ...
                                <a href="detail_pengumuman?id=<?= $announcement['id'] ?>" class="text-base font-bold text-red-950 flex items-center gap-1 group-hover:gap-2 transition-all">

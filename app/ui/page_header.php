...
<div class="relative w-full py-32 md:py-40 bg-cover bg-center bg-no-repeat bg-fixed bg-red-950"
     style="background-image: url('<?= $page_bg ?>'); ">
    
    <div class="absolute inset-0 bg-red-950" style="opacity: 0.80; mix-blend-mode: multiply;"></div>

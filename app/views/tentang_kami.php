...
<section class="py-20 bg-white font-sans text-gray-800" >
    <div class="container mx-auto px-6 md:px-12 max-w-6xl">
        ...
        <div class="text-center mb-16 relative animate-fade-in-up" data-aos="zoom-in">
            ...
            <div class="w-24 h-1.5 bg-[#002b54] mx-auto rounded-full" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20" >
            <div class="hidden lg:block lg:col-span-1 relative animate-fade-in-up delay-100">
                ...
                <div class="sticky top-32 flex flex-col gap-20 items-center">
                    <div class="w-4 h-4 rounded-full bg-[#002b54] ring-4 ring-blue-50" data-aos="fade-up"></div>
                    <div class="w-4 h-4 rounded-full bg-yellow-500 ring-4 ring-yellow-50" data-aos="fade-down"></div>
                    <div class="w-4 h-4 rounded-full bg-gray-300"></div>
                </div>
            </div>

            <div class="col-span-1 lg:col-span-11 space-y-8 text-lg leading-loose text-justify text-gray-700 animate-fade-in-up delay-200" data-aos="fade-up"
                ...
                <div class="pl-6 border-l-4 border-yellow-400 bg-yellow-50 py-4 pr-4 rounded-r-lg shadow-sm" data-aos="zoom-out">

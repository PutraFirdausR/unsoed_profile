    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 md:px-8 max-w-5xl">
            ...
            <div class="text-center mb-12" data-aos="zoom-in">
                ...
                <h2 class="text-3xl font-bold text-red-950 mt-2 mb-4">Dokumen IUP</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <?php foreach($documents as $index => $doc): ?>
                    <?php 
                    // Menambahkan AOS delay agar muncul bergantian
                    $aos_delay = ($index % 2) * 100; 
                    include __DIR__ . '/../components/iup_card.php'; 
                    ?>
                <?php endforeach; ?>
            </div>
            ...
            <div class="mt-12 text-center" data-aos="fade-up">
                <p class="text-sm text-gray-500 bg-gray-50 inline-block px-6 py-3 rounded-full border border-gray-200 shadow-sm">
                    <span class="font-bold text-red-950">Catatan:</span> Pastikan Anda menggunakan versi dokumen terbaru.
                </p>
            </div>
        </div>
    </section>

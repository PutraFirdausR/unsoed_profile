...
<div class="bg-gray-50 font-sans text-gray-800 w-full min-h-screen relative">
    ...
    <div class="container mx-auto px-4 md:px-8 relative z-10 max-w-5xl py-20">
        ...
        <div class="text-center mb-12" data-aos="zoom-in">
                ...
                <h2 class="text-3xl font-bold text-red-950 mt-2 mb-4">Layanan Magang Mahasiswa</h2>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 overflow-hidden border border-white flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2 bg-red-950 p-10 md:p-14 text-white flex flex-col justify-center relative overflow-hidden" data-aos="fade-right">
                ...
                <div class="absolute bottom-0 right-0 w-64 h-64 bg-red-500 rounded-full blur-[80px] opacity-20 translate-x-1/2 translate-y-1/2"></div>
                
                <div class="relative z-10" >
                    <span class="inline-block py-1.5 px-4 rounded-lg bg-red-500/20 border border-red-400/20 text-red-200 text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                        Layanan Akademik
                    </span>
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                        Program <br>Magang
                    </h2>
                    <p class="text-red-100/90 text-lg leading-relaxed mb-8 font-light">
                    ...
                    <div class="flex items-center gap-4 text-sm font-medium text-red-200">
                        <div class="flex -space-x-3">
                            <div class="w-10 h-10 rounded-full bg-red-400 border-2 border-red-950 flex items-center justify-center text-xs text-white">FH</div>
                            <div class="w-10 h-10 rounded-full bg-gray-200 border-2 border-red-950 flex items-center justify-center text-xs text-gray-600">Mitra</div>
                        </div>
            ...
            <div class="w-full md:w-1/2 bg-white p-10 md:p-14 flex flex-col justify-center items-center text-center" data-aos="fade-left" >
                ...
                <div class="w-24 h-24 bg-red-50 rounded-3xl flex items-center justify-center text-red-700 mb-6 shadow-sm transform hover:scale-105 transition-transform duration-300">
                ...
                <a href="/unsoed_profile/public/assets/docs/Magang.pdf" target="_blank" 
                   class="w-full max-w-xs group relative inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-300 bg-red-700 rounded-xl hover:bg-red-800 hover:shadow-xl hover:shadow-red-700/20 hover:-translate-y-1">

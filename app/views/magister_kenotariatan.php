...
$misi = [
    "Menyelenggarakan pendidikan hukum kenotariatan sesuai dengan standard akademik nasional Indonesia guna menghasilkan lulusan yang memiliki kompetensi akademik, profesional, dan berdaya saing global, serta memiliki moral yang baik dan kearifan lokal.",
    "Menyelenggarakan penelitian dengan roadmap yang konsisten serta berorientasi pada pengembangan ilmu hukum kenotariatan agar bermanfaat bagi masyarakat serta pembangunan nasional.",
    "Menyelenggarakan pengabdian kepada masyarakat berdasarkan kompetensi para dosen dan/atau mahasiswa yang berbasis pada hasil penelitian di bidang hukum kenotariatan guna membantu mengatasi permasalahan yang ada di masyarakat serta mendukung pembangunan nasional.",
    "Mengembangkan kerja sama dan membangun jejaring dengan berbagai pihak di tingkat daerah, nasional maupun internasional yang relevan dengan bidang Tri Dharma Perguruan Tinggi.",
...
// NOTE: DATA BIAYA PENDIDIKAN SUDAH DIHAPUS SESUAI PERMINTAAN

$materi_seleksi = [
    "Tes Potensial Akademik (TPA) & Tes TOEFL",
    "Tes Tertulis berupa pengetahuan dasar bidang hukum, meliputi: Hukum Perikatan, Hukum Jaminan, Hukum Perusahaan, dan Hukum Agraria/Pertanahan.",
    "Tes Wawancara"
];
...
$dosen_tetap = [
    ...
    "Prof. Dr. H. Abdul Aziz Ns, S.H., M.M., M.H.",
    "Prof. Dr. Hj. Sulistyandari, S.H., M.Hum.",
    "Prof. Dr. H. Kuat Puji Prayitno, S.H., M.Hum.",
    "Prof. Dr. H. Kadar Pamuji, S.H., M.H.",
    "Prof. Dr. Kartono, S.H., M.H.",
    "Prof. Dr. Riris Ardhanariswari, S.H., M.H.",
...
<div class="bg-gray-50 min-h-screen font-sans text-gray-800 pb-20 pt-10 scroll-smooth">
    <div class="container mx-auto px-4 md:px-8 max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-12 relative">
            ...
            <aside class="hidden lg:block lg:col-span-1">
                <?php 
                $sidebar_path = __DIR__ . '/../components/sidebar_mkn.php';
                if (file_exists($sidebar_path)) {
                    include $sidebar_path; 
                } else {
                    echo "<div class='text-red-500 border border-red-300 p-2 text-sm'>Sidebar not found at: $sidebar_path</div>";
                }
                ?>
            </aside>

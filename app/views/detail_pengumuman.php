...
<div class="container mx-auto px-4 py-12 max-w-3xl animate-fade-in-up">
    ...
    <div class="bg-white p-10 rounded-xl shadow-lg border border-gray-200">
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <span class="bg-red-50 text-red-600 px-3 py-1 rounded text-xs font-bold uppercase tracking-wider border border-red-100 self-start">PENTING</span>
        ...
        <div class="prose max-w-none text-gray-700 leading-loose text-lg">
            <p>Berikut adalah detail pengumuman yang disampaikan.</p>
        </div>
        
        <div class="mt-10 pt-6 border-t border-gray-100 flex justify-end">
             <button class="bg-[#002b54] text-white px-6 py-2 rounded shadow hover:bg-blue-900 transition flex items-center gap-2 cursor-pointer" onclick="window.print()">

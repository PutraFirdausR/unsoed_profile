    ...
    <section class="relative py-16 md:py-20">
        <div class="container mx-auto px-4 md:px-8 max-w-7xl">
            ...
            <div class="text-center mb-20 md:mb-28 animate-fade-in-up" data-aos="zoom-in">
                <span class="inline-block py-1.5 px-4 rounded-full bg-red-100 text-red-950 text-sm font-bold tracking-widest uppercase mb-4">
                    Fakultas Hukum UNSOED
                </span>
                <h2 class="text-4xl md:text-5xl font-extrabold text-red-950 tracking-tight">Periode Berjalan</h2>
            ...
            <div class="mb-32">
                ...
                <div class="flex justify-center mb-16 animate-fade-in-up delay-200" data-aos="zoom-in">
                    <div class="bg-white p-10 md:p-12 rounded-[2.5rem] shadow-2xl shadow-red-900/10 border-t-8 border-yellow-500 w-full max-w-2xl text-center transform hover:-translate-y-3 transition-all duration-500 relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            <div class="w-24 h-24 bg-red-950 text-yellow-400 rounded-2xl flex items-center justify-center text-4xl font-bold mx-auto mb-8 shadow-lg group-hover:rotate-3 transition-transform duration-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10" data-aos="fade-up">
                    <?php foreach($org_data['wakil_dekan'] as $i => $wd): 
                        $delay = ($i + 3) * 100; ?>
                    <div class="bg-white p-8 rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] border-b-4 border-red-950 hover:shadow-[0_20px_40px_rgba(69,10,10,0.1)] hover:-translate-y-2 transition-all duration-300 group animate-fade-in-up" style="animation-delay: <?= $delay ?>ms">
                        <div class="flex items-center justify-between mb-8">
                            <div class="w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center text-red-950 group-hover:bg-red-950 group-hover:text-white transition-colors duration-300 shadow-sm">
                            ...
                            <span class="text-5xl font-black text-gray-100 select-none group-hover:text-red-50/50 transition-colors duration-300"><?= $wd['kode'] ?></span>
                        </div>
                        <div class="space-y-2">
                            <span class="block text-xs font-bold text-red-600 uppercase tracking-widest">Wakil Dekan <?= $wd['kode'] ?></span>
                            <h4 class="text-xl font-bold text-gray-900 leading-snug group-hover:text-red-950 transition-colors"><?= $wd['nama'] ?></h4>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 mb-32">
                ...
                <div class="lg:col-span-8 animate-fade-in-up delay-300">
                    <div class="bg-white rounded-[2.5rem] p-10 md:p-12 shadow-xl border border-gray-100 h-full relative overflow-hidden" data-aos="zoom-in">
                         <div class="absolute top-0 left-0 w-full h-2 bg-linear-to-r from-red-950 to-red-700"></div>

                        <div class="flex items-center gap-5 mb-10" data-aos="fade-up">
                            <div class="p-4 bg-red-100 rounded-2xl text-red-950 shadow-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                            </div>
                            <h3 class="text-3xl font-bold text-red-950">Anggota Senat</h3>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            <div class="bg-red-950 text-white p-8 rounded-3xl relative overflow-hidden shadow-lg transform hover:scale-[1.02] transition-transform" data-aos="zoom-in-right">
                            ...
                            <div class="bg-white text-red-950 p-8 rounded-3xl border-2 border-red-50 shadow-md transform hover:scale-[1.02] transition-transform" data-aos="zoom-in-left">
                                <span class="block text-xs text-red-400 uppercase font-bold mb-3 tracking-wider">Sekretaris</span>
                        ...
                        <div data-aos="fade-up">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-10">
                                ...
                                <div class="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 hover:bg-red-50 transition-colors duration-300">
                ...
                <div class="lg:col-span-4 animate-fade-in-up delay-500 py-5">
                    <div class="bg-linear-to-br from-red-950 to-red-900 text-white p-10 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden h-full flex flex-col justify-center" data-aos="zoom-in">
                        <div class="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 bg-red-700 rounded-full opacity-20 blur-3xl animate-pulse"></div>
                        ...
                        <div class="relative z-10" >
                            ...
                            <ul class="space-y-10" data-aos="fade-up">
                                ...
                                <li class="group">
                                    <span class="block text-xs text-red-200 uppercase tracking-widest mb-2 group-hover:text-yellow-300 transition-colors"><?= $admin['jabatan'] ?></span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" >
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 hover:border-yellow-400 hover:shadow-[0_15px_30px_rgba(0,0,0,0.1)] hover:-translate-y-2 transition-all duration-500 p-8 flex flex-col h-full group animate-fade-in-up" style="animation-delay: <?= $delay ?>ms" data-aos="fade-up">
                        <div class="mb-8">
                            ...
                            <h4 class="font-black text-red-950 text-xl leading-tight min-h-14 flex items-center"><?= $bag[0] ?></h4>
                        </div>
                        <div class="mt-auto space-y-4">
                            <div class="bg-red-50/50 p-4 rounded-xl group-hover:bg-red-100/50 transition-colors duration-300">
                                <span class="block text-red-400 text-[10px] uppercase font-bold mb-1 tracking-wider">Ketua</span>
            ...
            <div class="animate-fade-in-up delay-500 py-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white p-0 rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-500 group animate-fade-in-up" style="animation-delay: <?= $delay ?>ms" data-aos="fade-up">
                        <div class="bg-red-950 p-6 border-b border-red-900 group-hover:bg-red-900 transition-colors">
                        ...
                        <div class="p-6 grid grid-cols-2 gap-6 bg-gray-50 group-hover:bg-white transition-colors">
                            <div>
                                ...
                                <span class="text-red-950 font-bold text-sm block"><?= $kj[1] ?: '-' ?></span>
                            </div>
                            <div class="border-l border-gray-200 pl-6">
                                <span class="block text-gray-400 uppercase font-bold text-[10px] mb-2 tracking-wider">Sekretaris</span>
                                <span class="text-red-950 font-bold text-sm block"><?= $kj[2] ?: '-' ?></span>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>

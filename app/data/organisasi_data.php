...
return [
    'dekan' => [
        'nama' => 'Prof. Dr. Riris Ardhanariswari, S.H., M.H.',
        'jabatan' => 'Dekan'
    ],
    'wakil_dekan' => [
        ['kode' => 'I',   'nama' => 'Dr. Aryuni Yuliantiningsih, S.H., M.H.'],
        ['kode' => 'II',  'nama' => 'Dr. Rahadi Wasi Bintoro, S.H., M.H.'],
        ['kode' => 'III', 'nama' => 'Dr. Siti Kunarti, S.H., M.Hum.']
    ],
    'senat' => [
        'ketua' => 'Prof. Dr. Ade Maman Suherman, S.H., M.Sc.',
        'sekretaris' => 'Sri Hartini, S.H., M.H.',
        'anggota' => [
    ...
    'administrasi' => [
        ['jabatan' => 'Kepala Bagian Umum', 'nama' => 'Suparno, S.E.'],
        ['jabatan' => 'Ketua Tim Akademik', 'nama' => 'Sumitro Budi Rahardjo, S.S.'],
        ['jabatan' => 'Ketua Tim Keuangan', 'nama' => 'Achmad Noor S.Sos.']
    ],
    'bagian' => [
